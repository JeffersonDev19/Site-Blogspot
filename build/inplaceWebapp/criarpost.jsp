							...
							<div id="mid-box" class="col-12 col-sm-12 col-md-12 col-lg-12">
								<div class="row">
									...
									<div id="mid-dashboard"
										...
										<form action='ControllerCreateTopico' method='post' Style='padding-left: 10px; padding-right: 10px; padding-top: 10px; padding-bottom: 10px; background-color: white; opacity: 0.9; border-radius: 5px;'>
												<div class='form-row'>
												<div class='form-group col-12 col-sm-12 col-md-12 col-lg-12'>
												<label for='lbl_titulo'>Titulo</label> <input type='text'
												class='form-control' id='titulo' name='titulo' placeholder='Titulo'>
												</div>
												<input name='IDUsuario' hidden value=<%=usuario.getId()%>>
												</div>
												<div class='form-group'>
												<label for='artxtTopico'>Novo Topico</label>
