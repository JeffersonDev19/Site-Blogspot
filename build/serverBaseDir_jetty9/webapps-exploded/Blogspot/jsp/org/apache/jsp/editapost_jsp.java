...
public final class editapost_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	Topico topico = repTopico.getPorID(request.getParameter("xml"));
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<form action='ControllerEditTopico' method='post'\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tStyle='padding-left: 10px; padding-right: 10px; padding-top: 10px; padding-bottom: 10px; background-color: white; opacity: 0.9; border-radius: 5px;'>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class='form-row'>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class='form-group col-12 col-sm-12 col-md-12 col-lg-12'>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<label for='lbl_titulo'>Titulo: ");
      out.print(topico.getTitulo());
      out.write("</label> <input type='text'\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tclass='form-control' id='titulo' name='titulo'\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tplaceholder='Novo Titulo'>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<label for='artxtTopico'>Novo Topico</label> <input\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tname=\"IDtopico\" hidden value=");
      out.print(topico.getId());
      out.write(">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<textarea class='form-control' rows='5' id='texto'\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tname='texto'>");
      out.print(topico.getTexto());
      out.write("</textarea>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class='form-row'>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class='form-group col-5 col-sm-5 col-md-5 col-lg-5'></div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<button type='submit' class='btn btn-primary col-md-2'>Confirmar\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</button>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class='form-group col-5 col-sm-5 col-md-5 col-lg-5'></div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</form>\r\n");
